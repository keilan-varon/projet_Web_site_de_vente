...
produitController.getProduitById(new URLSearchParams(document.location.search).get("num_prod")!).then((variantes: Produit[]) => {
    console.log(variantes);
    (document.querySelector("#detail-produit") as HTMLDivElement).innerHTML = `
    <div class="row">
    <div class="col-md-6">
      <img
